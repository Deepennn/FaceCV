...
import com.example.facecv.model.Result
...
object PrePostProcessor {
    ...
    private const val mOutputColumn = 5 + 1 // left, top, right, bottom, score and 80 class probability
    private const val mThreshold = 0.10f // score above which a detection is generated
    private const val mNmsLimit = 200
    ...
    fun nonMaxSuppression(
        ...
        val selected: ArrayList<Result> = ArrayList<Result>()
    ...
    fun outputsToNMSPredictions(
        ...
        val results: ArrayList<Result> = ArrayList<Result>()
